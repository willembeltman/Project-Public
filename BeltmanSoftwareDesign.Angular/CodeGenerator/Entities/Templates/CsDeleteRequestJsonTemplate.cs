...
{
    internal class CsDeleteRequestJsonTemplate : ITemplate
    {
        ...
        public CsDeleteRequestJsonTemplate(EntityInfo? entity, string csharp_shared_directory, string csharp_shared_namespace, ConstrainedProperty[] stateList, EntityInfo?[] uitgebreideKoppelList, EntityInfo?[] simpeleKoppelList, EntityInfo?[] attachmentEntitiesList)
        {
            this.entity = entity;
