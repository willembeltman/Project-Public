...
{
    public class FileRefInfo : IFtpFileInfo
    {
        public FileRefInfo(LocalApplication application, string path, ILogger logger)
        {
        ...
        public FileRefInfo(LocalApplication application, FileInfo realInfo, ILogger logger)
        {
            Application = application;
            RealInfo = realInfo;
            Logger = logger;
        ...
        public void MoveTo(string toPath)
        {
            ...
            var to = new FileRefInfo(Application, toPath, Logger);
