...
namespace LanCloud.Models
{
    ...
    {
        public FileStripe(FileInfo info)
        {
            Info = info;
        ...
        public FileStripe(DirectoryInfo dirinfo, string extention, byte[] indexes)
        {
            Extention = extention;
            Indexes = indexes;
        ...
        public FileStripe(DirectoryInfo dirinfo, string extention, byte[] indexes, long length, string hash)
        {
            Extention = extention;
            Indexes = indexes;
            Length = length;
