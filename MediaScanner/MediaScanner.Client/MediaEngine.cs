...
public class MediaEngine
{
    ...
    private readonly ConcurrentDictionary<string, MediaFileDto> _index = new(StringComparer.OrdinalIgnoreCase);
    ...
    public MediaEngine(List<string> scanDirectories, ILogger logger)
    {
        _scanDirectories = scanDirectories;
        _logger = logger;
    }

    public List<MediaFileDto> GetIndex() => _index.Values.ToList();
    ...
    private MediaFileDto? CreateMediaFileDto(string rootDir, string fullPath)
    {
        try
        {
