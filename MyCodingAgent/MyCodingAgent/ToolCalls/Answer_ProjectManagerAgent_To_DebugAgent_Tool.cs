...
public class Answer_ProjectManagerAgent_To_DebugAgent_Tool(Workspace workspace) : IToolCall
{
    public string Name
    ...
    public async Task<ToolResult> Invoke(OllamaToolCall toolCall)
    {
        ...
        var coderToolCall = workspace.CodingHistory
            ...
            .FirstOrDefault(a => a.tool_call.id == workspace.DebugAgent_WaitingFor_ProjectManagerAgent_Answer.ToolCallId);
