...
public class UsersUseCase(
    ...
    : gAPI.Core.Interfaces.IUseCase<User, Shared.Public.Dtos.User, Guid>
{
    ...
    public async Task<bool> CanCreateAsync(Shared.Public.Dtos.User dto, CancellationToken ct) => authenticationService.State.User != null;
    public async Task<bool> CanReadAsync(Shared.Public.Dtos.User dto, CancellationToken ct) => authenticationService.State.User != null;
    public async Task<bool> CanUpdateAsync(Shared.Public.Dtos.User dto, CancellationToken ct) => authenticationService.State.User != null;
    public async Task<bool> CanDeleteAsync(Shared.Public.Dtos.User dto, CancellationToken ct) => authenticationService.State.User != null;

    public async Task<User?> FindByMatchAsync(Shared.Public.Dtos.User dto, CancellationToken ct) 
    ...
    public async Task<bool> UpdateAsync(User updatedEntity, Shared.Public.Dtos.User dto, CancellationToken ct)
    {
